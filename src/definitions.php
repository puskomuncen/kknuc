...
return [
    ...
    "instansi" => \DI\autowire(Instansi::class),
    "kegiatan" => \DI\autowire(Kegiatan::class),
    "laporan_akhir" => \DI\autowire(LaporanAkhir::class),
    "logbook" => \DI\autowire(Logbook::class),
    "mahasiswa" => \DI\autowire(Mahasiswa::class),
    "pendaftaran" => \DI\autowire(Pendaftaran::class),
    "penempatan" => \DI\autowire(Penempatan::class),
