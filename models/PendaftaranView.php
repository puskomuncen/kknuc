 ...
 * Page class
 */
class PendaftaranView extends Pendaftaran
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PendaftaranView";
    ...
    // CSS class/style
    public string $CurrentPageName = "pendaftaranview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_pendaftaran") ?? Route("id_pendaftaran")) !== null) {
            $this->RecKey["id_pendaftaran"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_pendaftaran") ?? Route("id_pendaftaran")) !== null) {
            ...
            $this->RecKey["id_pendaftaran"] = $this->id_pendaftaran->QueryStringValue;
        } elseif (Post("id_pendaftaran") !== null) {
            $this->id_pendaftaran->setFormValue(Post("id_pendaftaran"));
            $this->RecKey["id_pendaftaran"] = $this->id_pendaftaran->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_pendaftaran->setQueryStringValue($keyValue);
            $this->RecKey["id_pendaftaran"] = $this->id_pendaftaran->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "pendaftaranlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("pendaftaranlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_pendaftaran->CurrentValue, $this->CurrentRow['id_pendaftaran'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pendaftaranlist"; // No matching record, return to list
                    } else {
