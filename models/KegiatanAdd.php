...
class KegiatanAdd extends Kegiatan
{
    ...
    // Page object name
    public string $PageObjName = "KegiatanAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "kegiatanadd";
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'id_kegiatan' first before field var 'x_id_kegiatan'
        $val = $this->hasFormValue("id_kegiatan") ? $this->getFormValue("id_kegiatan") : $this->getFormValue("x_id_kegiatan");
    }
