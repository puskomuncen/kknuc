 ...
 * Page class
 */
class InstansiView extends Instansi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "InstansiView";
    ...
    // CSS class/style
    public string $CurrentPageName = "instansiview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_instansi") ?? Route("id_instansi")) !== null) {
            $this->RecKey["id_instansi"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_instansi") ?? Route("id_instansi")) !== null) {
            ...
            $this->RecKey["id_instansi"] = $this->id_instansi->QueryStringValue;
        } elseif (Post("id_instansi") !== null) {
            $this->id_instansi->setFormValue(Post("id_instansi"));
            $this->RecKey["id_instansi"] = $this->id_instansi->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_instansi->setQueryStringValue($keyValue);
            $this->RecKey["id_instansi"] = $this->id_instansi->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "instansilist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("instansilist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_instansi->CurrentValue, $this->CurrentRow['id_instansi'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "instansilist"; // No matching record, return to list
                    } else {
