...
// Is modal
    ...
    public function getFilterList(): string
    {
        ...
        $filterList = Concat($filterList, $this->prodi->AdvancedSearch->toJson(), ","); // Field prodi
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field prodi
        $this->prodi->AdvancedSearch->SearchValue = $filter["x_prodi"] ?? "";
        $this->prodi->AdvancedSearch->SearchOperator = $filter["z_prodi"] ?? "";
        $this->prodi->AdvancedSearch->SearchCondition = $filter["v_prodi"] ?? "";
        $this->prodi->AdvancedSearch->SearchValue2 = $filter["y_prodi"] ?? "";
        $this->prodi->AdvancedSearch->SearchOperator2 = $filter["w_prodi"] ?? "";
        $this->prodi->AdvancedSearch->save();
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->prodi); // prodi
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "prodi");
