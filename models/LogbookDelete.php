 ...
 * Page class
 */
class LogbookDelete extends Logbook
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "LogbookDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "logbookdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("logbooklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("logbooklist"); // Return to list
                return;
            }
        }
