 ...
 * Page class
 */
class LaporanAkhirDelete extends LaporanAkhir
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "LaporanAkhirDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "laporanakhirdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("laporanakhirlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("laporanakhirlist"); // Return to list
                return;
            }
        }
