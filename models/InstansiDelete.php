 ...
 * Page class
 */
class InstansiDelete extends Instansi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "InstansiDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "instansidelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("instansilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("instansilist"); // Return to list
                return;
            }
        }
