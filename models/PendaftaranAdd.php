 ...
 * Page class
 */
class PendaftaranAdd extends Pendaftaran
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "PendaftaranAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "pendaftaranadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "pendaftaranview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'id_pendaftaran' first before field var 'x_id_pendaftaran'
        $val = $this->hasFormValue("id_pendaftaran") ? $this->getFormValue("id_pendaftaran") : $this->getFormValue("x_id_pendaftaran");
    }
    ...
    protected function getAddRow(): array
    {
        ...
        // id_kegiatan
        $this->id_kegiatan->setDbValueDef($newRow, $this->id_kegiatan->CurrentValue, false);
