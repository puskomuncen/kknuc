...
class KegiatanView extends Kegiatan
{
    ...
    // Page object name
    public string $PageObjName = "KegiatanView";
    ...
    // CSS class/style
    public string $CurrentPageName = "kegiatanview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_kegiatan") ?? Route("id_kegiatan")) !== null) {
            $this->RecKey["id_kegiatan"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_kegiatan") ?? Route("id_kegiatan")) !== null) {
            ...
            $this->RecKey["id_kegiatan"] = $this->id_kegiatan->QueryStringValue;
        } elseif (Post("id_kegiatan") !== null) {
            $this->id_kegiatan->setFormValue(Post("id_kegiatan"));
            $this->RecKey["id_kegiatan"] = $this->id_kegiatan->FormValue;
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kegiatanlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_kegiatan->CurrentValue, $this->CurrentRow['id_kegiatan'])) {
