 ...
 * Page class
 */
class PendaftaranDelete extends Pendaftaran
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PendaftaranDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "pendaftarandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("pendaftaranlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("pendaftaranlist"); // Return to list
                return;
            }
        }
