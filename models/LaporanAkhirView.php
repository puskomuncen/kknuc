 ...
 * Page class
 */
class LaporanAkhirView extends LaporanAkhir
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "LaporanAkhirView";
    ...
    // CSS class/style
    public string $CurrentPageName = "laporanakhirview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_laporan") ?? Route("id_laporan")) !== null) {
            $this->RecKey["id_laporan"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_laporan") ?? Route("id_laporan")) !== null) {
            ...
            $this->RecKey["id_laporan"] = $this->id_laporan->QueryStringValue;
        } elseif (Post("id_laporan") !== null) {
            $this->id_laporan->setFormValue(Post("id_laporan"));
            $this->RecKey["id_laporan"] = $this->id_laporan->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_laporan->setQueryStringValue($keyValue);
            $this->RecKey["id_laporan"] = $this->id_laporan->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "laporanakhirlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("laporanakhirlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_laporan->CurrentValue, $this->CurrentRow['id_laporan'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "laporanakhirlist"; // No matching record, return to list
                    } else {
