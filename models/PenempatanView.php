...
class PenempatanView extends Penempatan
{
    ...
    // Page object name
    public string $PageObjName = "PenempatanView";
    ...
    // CSS class/style
    public string $CurrentPageName = "penempatanview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_penempatan") ?? Route("id_penempatan")) !== null) {
            $this->RecKey["id_penempatan"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_penempatan") ?? Route("id_penempatan")) !== null) {
            ...
            $this->RecKey["id_penempatan"] = $this->id_penempatan->QueryStringValue;
        } elseif (Post("id_penempatan") !== null) {
            $this->id_penempatan->setFormValue(Post("id_penempatan"));
            $this->RecKey["id_penempatan"] = $this->id_penempatan->FormValue;
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("penempatanlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_penempatan->CurrentValue, $this->CurrentRow['id_penempatan'])) {
